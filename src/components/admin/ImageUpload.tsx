/**
 * Componente: Upload de Imagem (Admin)
 *
 * Widget de upload de imagens com drag-and-drop. Suporta multiplos buckets
 * (categorias, servicos, portfolio). Valida tipo e tamanho do arquivo.
 * Exibe preview da imagem atual e botao para remover.
 *
 * Props:
 * - bucket: Bucket de armazenamento ("categories" | "services" | "portfolio")
 * - currentUrl: URL da imagem atual (null se nenhuma)
 * - onUpload: Callback com URL da imagem enviada
 * - onRemove: Callback quando usuario remove a imagem
 * - className: Classes CSS customizadas
 *
 * Limites: Apenas imagens, maximo 5MB
 */
"use client";
