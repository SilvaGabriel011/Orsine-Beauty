/**
 * Componente: Carrossel de Categorias
 *
 * Carrossel horizontal e scrollavel com opcoes de categorias e filtro "Todos".
 * Permite ao usuario selecionar categorias para filtrar os servicos.
 * Em desktop, exibe setas para navegar; em mobile, permite scroll de toque.
 *
 * Props:
 * - categories: Array de categorias disponiveis
 * - selectedCategoryId: ID da categoria atual selecionada (null = Todos)
 * - onSelectCategory: Callback quando usuario clica em uma categoria
 */
"use client";
...
export default function CategoryCarousel({
  ...
  // Funcao para navegar o carrossel de forma suave
  ...
  return (
    <div className="relative w-full">
      ...
      >
        {/* Opcao "Todos" - mostra todos os servicos sem filtro */}
        <button
