/**
 * Pagina: Meus Agendamentos (Area do Cliente)
 *
 * Lista de todos os agendamentos do cliente passados e futuros.
 * Permite visualizar detalhes, avaliar servicos realizados, cancelar
 * agendamentos futuros e remarcar.
 *
 * Server Component que valida autenticacao e carrega agendamentos do cliente.
 * Renderiza AgendamentosClient para integracao com actions.
 */
