/**
 * API Route: /api/admin/store/items
 *
 * Gerencia itens da loja de recompensas (admin).
 *
 * POST — Admin cria novo item (desconto, servico, produto)
 */
...
// Schema de validacao para criar item
...
// POST: Admin cria novo item de loja (requer admin)
export const POST = withErrorHandler(async (request: NextRequest) => {
  ...
  // Cria item: desconto (imediato), servico (voucher), ou produto (fisico)
